...
<h5>Report Kinerja Per Bulan Kanal</h5>
<div class="table-responsive" style="margin-bottom: 5%">
    <table id="tableKinerjaPerbulanKanal" class="table table-striped align-middle text-nowrap">
...
@section('custom-js')
    <script type="module" src="/js/report/kinerjaPerBulanKanal.js"></script>
@endsection