...
<h5>Rekapitulasi GWP Per Produk</h5>

<div  class="table-scroll" style="height: 560px; margin-bottom: 5%" >
    <table id="tableActualPerProduk" class="main-table table table-borderless table-striped table-hover text-nowrap">
        <thead>
            <tr>
                ...
                <th scope="col" style="border: 1px solid black; color:white; background-color: #4472C4; z-index:999; width: 300px; min-width: 300px; max-width: 300px;" class="text-center align-middle" rowspan="2">PRODUK</th>
...
@section('custom-js')
    <script type="module" src="/js/report/actualPerProduk.js"></script>
@endsection