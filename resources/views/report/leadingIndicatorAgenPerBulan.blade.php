...
<h5>Report Leading Indicator Perbulan Agen</h5>
    <table id="tableLeadingIndicatorAgenPerBulan" class="display table table-bordered" style="width:100%">
...
@section('custom-js')
    <script type="module" src="/js/report/leadingIndicatorAgenPerBulan.js"></script>
@endsection