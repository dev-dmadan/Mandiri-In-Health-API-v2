...
<h5>Rekapitulasi Progress Pipeline Renewal Per Bulan</h5>
<div class="table-responsive" style="margin-bottom: 5%">
    <table id="tablePipelineRenewalPerBulan" class="table table-striped  text-nowrap" >
        <thead>
            <tr>
                <th rowspan="3" style="border: 1px solid black; color:white; background-color:#4472c4" class="text-center align-middle">NO</td>
                <th rowspan="3" style="border: 1px solid black; color:white; background-color:#4472c4" class="text-center align-middle">BULAN</td>
...
@section('custom-js')
      <script type="module" src="/js/report/pipelineRenewalPerBulan.js"></script>
@endsection