...
<h5>Report Kinerja Ka. Unit Per Produk</h5>
<div  class="table-scroll" style="height: 605px; margin-bottom: 5%" >
    <table id="tableKinerjaKaUnitPerProduk" class="main-table table table-borderless table-striped table-hover">
        <thead>
            <tr>
                ...
                <th scope="col" style="border: 1px solid black; color:white; background-color: #4472C4; z-index:999; width: 250px; min-width: 250px; max-width: 250px;" class="text-center align-middle" rowspan="3">NAMA KA. UNIT</th>
...
@section('custom-js')
    <script type="module" src="/js/report/kinerjaKaUnitPerProduk.js"></script>
@endsection