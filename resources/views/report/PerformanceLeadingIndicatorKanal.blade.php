...
<div class="table-responsive" style="margin-bottom: 5%">
    <table id="tableLeadingIndicatorKanal" class="table table-striped align-middle text-nowrap">
        <thead class="bgKprimary">
            <tr>
                ...
                <th style="border: 1px solid black; color:white; background-color: #4472C4" class="text-center align-middle" rowspan="2">KANAL DISTRIBUSI</th>
