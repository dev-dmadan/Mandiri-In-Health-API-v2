...
<h5>Report Kinerja Produk Per Kanal</h5>
<div class="table-responsive" style="margin-bottom: 5%">
    <table id="tableKinerjaProductPerKanal" class="table table-striped align-middle text-nowrap">
...
@section('custom-js')
    <script type="module" src="/js/report/kinerjaProdukPerKanal.js"></script>
@endsection