...
<h5>Report Kinerja Per Bulan Agen</h5>
<div class="table-responsive" style="margin-bottom: 5%">
    <table id="tableKinerjaPerbulanAgen" class="table table-striped align-middle text-nowrap">
...
@section('custom-js')
    <script type="module" src="/js/report/kinerjaPerBulanAgen.js"></script>
@endsection