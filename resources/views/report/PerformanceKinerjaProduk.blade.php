...
<h5>Report Kinerja Produk</h5>
<div class="table-responsive" style="margin-bottom: 5%">
    <table id="tableKinerjaProduct" class="table table-striped align-middle text-nowrap">
        <thead class="bgKprimary">
            <tr>
                ...
                <th style="border: 1px solid black; color:white; background-color: #4472C4" class="text-center align-middle" rowspan="3">PRODUK</th>
...
@section('custom-js')
    <script type="module" src="/js/report/kinerjaProduk.js"></script>
@endsection