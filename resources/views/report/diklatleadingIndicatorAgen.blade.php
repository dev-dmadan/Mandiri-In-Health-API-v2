...
<div  class="table-scroll" style="height: 565px; margin-bottom: 5%" >
    <table id="tableLeadingIndicatorAgen" class="main-table table table-borderless table-striped table-hover">
        <thead>
            <tr>
                ...
                <th scope="col" style="border: 1px solid black; color:white; background-color: #4472C4;  z-index:999; width: 300px; min-width: 300px; max-width: 300px;" class="text-center align-middle" rowspan="2">NAMA AGEN ASURANSI</th>
