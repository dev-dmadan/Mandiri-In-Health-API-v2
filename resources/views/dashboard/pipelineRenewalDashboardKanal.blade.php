...
<div class="row"> 
    ...
    <div class="col-md-4 col-lg-4">
        <div class="mb-3 card" style="background-color: #7030A0;background-image:url('Untitled-7-01.png');background-repeat: no-repeat;background-size: auto;">
    ...
    <!-- LAPSE -->
    <div class="col-md-4 col-lg-4">
        <div class="mb-3 card" style="background-color: #FF289E;background-image:url('Untitled-6-01.png');background-repeat: no-repeat;background-size: auto;">
            <div class="card-body" style="text-align: center;">
    ...
    <!--- IN PROGRESS -->
     <div class="col-md-4 col-lg-4">
        <div class="mb-3 card" style="background-color: #4472C4;background-image:url('Untitled-5-01.png');background-repeat: no-repeat;background-size: auto;">
            <div class="card-body" style="text-align: center;">
                           ...
                           <div class="widget-chat-wrapper-outer">
                               <div class="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                                   <div id="chartpipelinebyprogress"></div>
                                    @section('custom-js')
                                        <script src="/js/pipelineRenewalDashboardKanal.js"></script>
                                    @endsection
                               </div>
                           </div>
                       </div>
