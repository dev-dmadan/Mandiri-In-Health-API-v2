    ...
    <div class="row">
        <div class="col-md-2 col-lg-2">
            <div class="mb-3 card"
                ...
                <div class="card-body" style="text-align: center;">
                    <div><i class="fa fa-gears" style="font-size:48px;color:white"></i></div>
        ...
        <div class="col-md-2 col-lg-2">
            <div class="mb-3 card"
                ...
                <div class="card-body" style="text-align: center;">
                    <div><i class="fa fa-dollar" style="font-size:48px;color:white"></i></div>
                                    ...
                                    <div class="widget-chat-wrapper-outer">
                                        <div class="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                                            <div id="chartpipelinekomitmenbykanal"></div>
                                                @section('custom-js')
                                                    <script src="/js/pipelineDashboardNewBusinessKanal.js"></script>
                                                @endsection
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table id="tableListPipelineKomitmenKanal"
                                                ...
                                                <thead>
                                                    <tr style="background-color:#16aaff;color:white;font-weight: bold;">
                                                        ...
                                                        <th style="text-align:center;width:20%;">KANAL DISTRIBUSI</th>
                                    ...
                                    <table id="tableRekapPipelineNewBusiness"
                                        ...
                                        <thead>
                                            <tr style="background-color:#16aaff;color:white;font-weight: bold;">
                                                ...
                                                <th style="border: 1px solid" class="text-center" colspan='2'>LOSS</th>
                                            </tr>
                                            <tr style="background-color:#16aaff;color:white;font-weight: bold;">
