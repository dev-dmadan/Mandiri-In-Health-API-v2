...
function printExcel() {
    let tableData = document.getElementById("tableKinerjaAgen").outerHTML;
    tableData = tableData.replace(/<A[^>]*>|<\/A>/g, ""); //remove if u want links in your table
    tableData = tableData.replace(/<input[^>]*>|<\/input>/gi, ""); //remove input params

    let a = document.createElement('a');
    a.href = `data:application/vnd.ms-excel, ${encodeURIComponent(tableData)}`
    a.download = 'Kinerja Agen' + '.xls'
    a.click();
}
...
function reload() {
    window.location = `${APP_URL}/report/view/reportKinerjaAgen`;
}
 ...
 * @returns LIST
 */
async function getKinerjaAgen() {
    try {
        const headers = new Headers();
        headers.append("Content-Type", "application/json");
        const req = await fetch(`${APP_URL}/dashboard/api/report-get-kinerja-agen?SecretKey=${SECRET_KEY}`, {
            method: 'POST',
            headers: headers,
            body: JSON.stringify({
 ...
 * @returns VIEW
 */
async function renderListKinerjaAgen() {
    const req = await getKinerjaAgen();
    const result = req.KinerjaAgenResult;
    ...
    const tbody = document.querySelector('#tableKinerjaAgen tbody');
    
    let seqNo = 1;
    result.ListItem.forEach(item => {
    let rows =  `<td style="border: 1px solid" class="text-center">${seqNo}</td>` +
                ...
                `<td style="border: 1px solid" class="text-center">${item.Item4}</td>` +
                `<td style="border: 1px solid" class="text-center">${item.Item5}</td>` + 
                `<td style="border: 1px solid" class="text-center"><div style="background-color: ${progressBarColor(item.Item5,  item.Item4)};border-radius:50%;width:15px;height:15px;"></div></td>` +
                `<td style="border: 1px solid" class="text-center">${item.Item6}</td>` + 
                `<td style="border: 1px solid" class="text-center">${item.Item7}</td>` +
                `<td style="border: 1px solid" class="text-center">${item.Item8}</td>` + 
                `<td style="border: 1px solid" class="text-center"><div style="background-color: ${progressBarColor(item.Item8, item.Item7)};border-radius:50%;width:15px;height:15px;"></div></td>` +
                `<td style="border: 1px solid" class="text-center">${item.Item9}</td>` + 
                `<td style="border: 1px solid" class="text-center">${item.Item10}</td>` +
                `<td style="border: 1px solid" class="text-center">${item.Item11}</td>` +
                `<td style="border: 1px solid" class="text-center"><div style="background-color: ${progressBarColor(item.Item11, item.Item11)};border-radius:50%;width:15px;height:15px;"></div></td>`
    ...
    let rowsTotal = `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" colspan="3" class="text-center">TOTAL</td>` +
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item1}</td>` +
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item2}</td>` +
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item3}%</td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center"><div style="background-color: ${progressBarColor(result.Total.Item3, result.Total.Item2)};border-radius:50%;width:15px;height:15px;"></div></td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item4}</td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item5}</td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item6}%</td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center"><div style="background-color: ${progressBarColor(result.Total.Item6. result.Total.Item5)};border-radius:50%;width:15px;height:15px;"></div></td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item7}</td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item8}</td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center">${result.Total.Item9}%</td>`+ 
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center"><div style="background-color: ${progressBarColor(result.Total.Item9, result.Total.Item8)};border-radius:50%;width:15px;height:15px;"></div></td>`
