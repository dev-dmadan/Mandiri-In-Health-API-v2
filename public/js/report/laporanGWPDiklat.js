 ...
 * @returns LIST
 */
async function getLaporanGWPDiklat() {
    try {
        const headers = new Headers();
        headers.append("Content-Type", "application/json");
 ...
 * @returns VIEW
 */
async function renderLaporanGWPDiklat() {
    const req = await getLaporanGWPDiklat();
    ...
    const tbody = document.querySelector('#tableLaporanGWPDiklat tbody');
    ...
    let rows =  `<td style="border: 1px solid" class="text-center">${seqNo}</td>` +
                ...
                `<td style="border: 1px solid" class="text-center"><div style="background-color: ${progressBarColor(item.Item5)};border-radius:50%;width:15px;height:15px;"></div></td>` +
                ...
                `<td style="border: 1px solid" class="text-center"><div style="background-color: ${progressBarColor(item.Item8)};border-radius:50%;width:15px;height:15px;"></div></td>` +
                ...
                `<td style="border: 1px solid" class="text-center"><div style="background-color: ${progressBarColor(item.Item11)};border-radius:50%;width:15px;height:15px;"></div></td>`
    ...
    let rowsTotal = `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" colspan="3" class="text-center">TOTAL</td>` +
                    ...
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center"><div style="background-color: ${progressBarColor(result.Total.Item3)};border-radius:50%;width:15px;height:15px;"></div></td>`+ 
                    ...
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center"><div style="background-color: ${progressBarColor(result.Total.Item6)};border-radius:50%;width:15px;height:15px;"></div></td>`+ 
                    ...
                    `<td style="border: 1px solid black; background-color: #4472C4; text-align: center; color:white; font-weight:bold" class="text-center"><div style="background-color: ${progressBarColor(result.Total.Item9)};border-radius:50%;width:15px;height:15px;"></div></td>`
